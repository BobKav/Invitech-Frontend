        ...
        const response = await new Promise(resolve => 
          setTimeout(() => resolve({
            ...
            json: () => Promise.resolve({
              id: eventId,
              name: "Mariage de Sophie et Thomas",
              description: "Célébration du mariage de Sophie et Thomas. Une journée remplie d'amour et de joie !",
              date: "2024-08-15",
              time: "14:00",
              ...
              status: "À venir",
              tasks: [
                { id: 1, name: "Confirmer le traiteur", completed: true },
                { id: 2, name: "Envoyer les invitations", completed: true },
                { id: 3, name: "Finaliser la liste de musique", completed: false },
              ]
            })
          }), 1000)
        );
